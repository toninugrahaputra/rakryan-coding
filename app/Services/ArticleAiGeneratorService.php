...
class ArticleAiGeneratorService
{
    ...
    private function buildPrompt(string $title): string
    {
        return <<<PROMPT
            ...
            Tulis artikel lengkap dengan judul: "{$title}"
            ...
            - Minimal 6 blocks, terstruktur rapi (heading section lalu paragraf penjelasan), isi harus benar-benar relevan dengan judul, jangan generik.
