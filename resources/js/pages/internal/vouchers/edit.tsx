...
import { update } from '@/actions/App/Http/Controllers/Internal/VoucherController';
import { edit, index } from '@/routes/internal/vouchers';
...
export default function VouchersEdit({ voucher, products }: { voucher: VoucherProp; products: Product[] }) {
    const [form, setForm] = useState({
        ...
        applies_to_all_products: voucher.applies_to_all_products,
